...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: LkNl79DvtKw8Z1/css
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: J0dZe4c0t_vSbZ/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: WYa-AUimm31U5M/icon
...
function PlasmicPageLayout__RenderFunc(props) {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__gw9LH)}
          role={"img"}
        />
      }
      navMenuItems={[
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx =>
              true ? (
                <div className={classNames(projectcss.all, sty.freeBox__zzv4Y)}>
                  <IconIcon
                    className={classNames(projectcss.all, sty.svg__vz1Ir)}
                    role={"img"}
                  />
                </div>
              ) : null
      ...
      >
        <ph.DataCtxReader>
          {$ctx =>
            true ? (
              <div className={classNames(projectcss.all, sty.freeBox__qLt63)}>
                {p.renderPlasmicSlot({
                  defaultContents: (
                    <section
                      className={classNames(projectcss.all, sty.section__jzvKb)}
                    >
                      <h1
                        className={classNames(
                          projectcss.all,
